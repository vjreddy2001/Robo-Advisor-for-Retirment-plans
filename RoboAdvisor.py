...
def get_investment_recommendation(risk_level):
    ...
    #return (risk_level["sessionAttributes"], "Fulfilled", risk_levels[risk_level["currentIntent"]["slots"]["riskLevel"].lower()])
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimum investment amount is $5,000D, "
...
def dispatch(intent_request):
    ...
    if intent_name == "Robo_Advisor":
        
        return recommend_portfolio(intent_request)
    #if intent_name == "investmentAmount":
